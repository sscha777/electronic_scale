...
#define CONFIG_USE_SPI_ETHERNET 0
...
#define CONFIG_ETH_SPI_INT0_GPIO 32
#define CONFIG_ETH_SPI_PHY_RST0_GPIO 33
#define CONFIG_ETH_SPI_PHY_ADDR0 1
#define CONFIG_ETH_SPI_HOST HSPI_HOST
...
void eth_test_task(void)
{
    ...
    for (int i = 0; i < CONFIG_SPI_ETHERNETS_NUM; i++)
    {
        ...
        eth_w5500_config_t w5500_config = ETH_W5500_DEFAULT_CONFIG(0,&devcfg);
